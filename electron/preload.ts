...
contextBridge.exposeInMainWorld('electronAPI', {
  // 获取机器码
  getMachineId: (query:any) => ipcRenderer.invoke('getMachineId',query),
  getDeviceInfo: () => ipcRenderer.invoke('getDeviceInfo'),
  checkDir: (query:string) => ipcRenderer.invoke('checkDir',query),
  checkSsh: (data:any) => ipcRenderer.invoke('checkSsh',data),
